...
abstract: "AI agentic systems have emerged as autonomous software powered by large language models, increasingly deployed in critical domains. This talk offers a perspective on how adversarial machine learning research has evolved over the past decade and examines the novel threats that agentic systems introduce. We will discuss two recent research projects: building trusted infrastructure for AI agents, and mitigating risks arising from agent interaction with untrusted tools and data. The talk will conclude with a discussion of open problems in trustworthy AI agents and directions for future research."
youtube: 5T0jpKBQaSA
---